...
* using "Twitter Bootstrap":http://twitter.github.com/bootstrap/index.html for public appearence
* started conversion to HAML & SASS
* configurable via ENV vars (ENKI_TITLE, ENKI_AUTHOR_NAME, etc.)
* deployable to "Heroku":http://www.heroku.com/
* link to Google Plus profile to allow "author information in search results":http://support.google.com/webmasters/bin/answer.py?hl=en&answer=1408986
